...
public class ControllerVerAsientoDetalle implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        choiceBox.setItems(getAsientoList());
        showAsientosInicial();
    }
    ...
    public ObservableList<AsientoCuenta> getAsientoCuentaListInicial(){
        ...
        String query = "SELECT nombre,fecha,descripcion,idcuenta,debe,haber,saldo FROM asientos a INNER JOIN cuenta_asiento ca on(a.id=ca.idasiento) INNER JOIN cuentas c on (ca.idcuenta=c.codigo) ORDER BY fecha,idasiento;";
        Statement st;
        ResultSet rs;
        try {
    ...
    public ObservableList<Integer> getAsientoList(){
        ObservableList<Integer> list = FXCollections.observableArrayList();
        Connection connection = getConnection();
        String query = "SELECT id FROM asientos;";
        Statement st;
        ResultSet rs;
        try {
            st = connection.createStatement();
    ...
    public ObservableList<AsientoCuenta> getAsientoCuentaList(){
        ObservableList<AsientoCuenta> asientosList = FXCollections.observableArrayList();
        Connection connection = getConnection();
        String query = "SELECT nombre,fecha,descripcion,idcuenta,debe,haber,saldo FROM asientos a INNER JOIN cuenta_asiento ca on(a.id=ca.idasiento) INNER JOIN cuentas c on (ca.idcuenta=c.codigo) WHERE id="+choiceBox.getValue()+ "  ORDER BY fecha,idasiento";
        Statement st;
        ResultSet rs;
        try {
            st = connection.createStatement();
