...
public class ControllerHabilitarCuenta implements Initializable {
    ...
    public ObservableList<String> getCuentasList(){
        ...
        String query = "SELECT nombre FROM cuentas WHERE recibe_saldo='Si' AND habilitada='No';";
        Statement st;
        ResultSet rs;
        try {
    ...
    public void habilitar(ActionEvent event)  {
        String querry= "update cuentas set habilitada='Si' where nombre='"+ choiceBox.getValue()+"'";
        executeQuery(querry);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (getCuentasList().isEmpty()){
            mensajeLabel.setText("No hay cuentas deshabilitadas");
        }
